...
- [x] T007 — Create initial Angular 21 workspace under `frontend/house-management-web`
- [x] T008 — Verify Angular strict mode, routing and standalone component configuration
